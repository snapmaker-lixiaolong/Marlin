...
#define STRING_CONFIG_H_AUTHOR "(SNAPMAKER)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_SNAPMAKER_ORIGINAL
#endif
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {(200.0*16/8),(200.0*16/8),(200.0*16/8),(200.0*16/3.1415926/11.0)}  // default steps per unit for Ultimaker
...
#define MANUAL_PROBE_START_Z 10
